...
<div class="col l6 push-s3">
 ...
 <label style="color:black;font-size:16px;color:#fff;">Triés par :</label>
  ...
  <select class="browser-default" id="select" style="border:1px solid black;padding-top:2px;">
...
<div class="collection">
    <a href="/home" class="collection-item"><span class="badge">{{$services->count()}}</span><span>Tout</span></a>
...
<div class="col l9">
      ...
      <div class="row">
      <div class="col s12">
      <h4 class="center-align" style="font-size:20px;"> Les services récemment ajoutés..</h4>
      </div>
      </div>  
...
<br><br>
        <div class="row">
        <div class="col s12">
        <span style="color:purple;" > Catégorie : </span><span>{{$service->services_id}}</span>
        </div>
        </div>
        ...
        <div class="row">
        <div class="col s12">
        <span  > Avis :  </span><span style="color:purple;">{{count($services)}}</span>
        </div>
        </div>
